...
- **Inbox Composer**: Fixed handling of attachment previews. The message feed inside [Inbox.jsx](client/src/pages/user/Inbox.jsx) now dynamically maps incoming Socket.IO events and JSON files to output dedicated React components:
...
The following modules remain as placeholders or stubs, as prioritized in [SPRINT2_SCOPE.md](SPRINT2_SCOPE.md):
