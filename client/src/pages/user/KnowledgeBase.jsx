    ...
    <div className="page-stack">
      ...
      <div className="page-header">
        <div>
          ...
          <p>
            Provide documents or website links to feed contextual information into the CRM AI
            chatbot responder.
          </p>
        </div>
      </div>
        ...
        <div className="panel-stack" style={{ display: 'grid', gap: '24px' }}>
          ...
          <form className="panel form-panel" onSubmit={handleFileUpload}>
            ...
            <p className="muted-copy" style={{ marginBottom: '16px' }}>
              Upload local documents (PDF, DOCX, or TXT) to extract text and index them
              asynchronously.
            </p>
          ...
          {loading ? (
            ...
            <p className="muted-copy" style={{ padding: '24px', textAlign: 'center' }}>
              {searchQuery
                ...
                : 'Your Knowledge Base is currently empty. Upload files or scrape URLs to get started.'}
            </p>
          ) : (
                      ...
                      <tr key={item.id}>
                        ...
                        <td>
                          {cleanStatus === 'failed' ? (
                            ...
                            <span className="status-badge indexing">⚙ Indexing</span>
                          ) : cleanStatus === 'pending' ? (
