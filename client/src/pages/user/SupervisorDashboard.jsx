    ...
    <div className="page-stack">
      <div className="page-header">
        <div>
          ...
          <p>
            Monitor customer response velocities, handle escalated queues, and track service level
            agreement (SLA) status.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div
          className="panel"
          style={{ padding: '20px', borderLeft: '4px solid #1ea085', borderRadius: '12px' }}
        >
          <span
        ...
        <div
          className="panel"
          style={{ padding: '20px', borderLeft: '4px solid #3182ce', borderRadius: '12px' }}
        >
          <span
            className="muted-copy"
            style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.05em' }}
        ...
        <div
          className="panel"
          style={{ padding: '20px', borderLeft: '4px solid #dd6b20', borderRadius: '12px' }}
        >
          <span
            className="muted-copy"
            style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.05em' }}
          ...
          <h2 style={{ fontSize: '28px', margin: '8px 0 0 0', color: '#dd6b20' }}>
            {kpis.escalatedChatsCount}
          </h2>
        ...
        <div
          className="panel"
          style={{ padding: '20px', borderLeft: '4px solid #e53e3e', borderRadius: '12px' }}
        >
          <span
            className="muted-copy"
            style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.05em' }}
          ...
          <h2 style={{ fontSize: '28px', margin: '8px 0 0 0', color: '#e53e3e' }}>
            {kpis.totalSlaBreaches}
          </h2>
      ...
      <div className="two-column-grid">
        ...
        <div className="panel form-panel">
          ...
          <p className="muted-copy" style={{ marginBottom: '16px' }}>
            Chats in this list have breached the 5-minute response SLA. Clear escalations by
            resolving them or messaging the customer.
          </p>
          ...
          {loading ? (
            ...
            <div
              style={{
                textAlign: 'center',
                padding: '36px',
                background: 'rgba(30,160,133,0.02)',
                borderRadius: '12px',
                  ...
                  >
                    <div>
                      <strong style={{ fontSize: '14px' }}>
                        {esc.sender_name} ({esc.sender_mobile})
                      </strong>
                      <div
                        className="muted-copy"
                        style={{ fontSize: '11px', textTransform: 'capitalize' }}
                      >
                        Source: {esc.origin} | Escalated at:{' '}
                        {new Date(esc.escalated_at).toLocaleTimeString()}
                      </div>
                    </div>
                    <span
                    ...
                    <tr key={agent.agent_uid}>
                      ...
                      <td>
                        <span
                          style={{
                            fontWeight: 'bold',
                            color: agent.avg_time > 300 ? '#e53e3e' : '#1ea085',
                          }}
                        >
