...
### Gated Portals & Roles
*   **Tenant Admin (`admin@example.com` / `<DEV_PASSWORD>`)**:
...
*   **Workspace Owner (`user@example.com` / `<DEV_PASSWORD>`)**:
...
*   **Workspace Agent (`demo_agent_local-@example.com` / `<PASSWORD>`)**:
...
*   **Login Interface**:
    ![Login Page](<LOCAL_SCREENSHOT_PATH>/01_login_page.png)
*   **Dashboard (After Seeding)**:
    ![Dashboard](<LOCAL_SCREENSHOT_PATH>/03_dashboard_after_seeding.png)
*   **Contacts Inventory**:
    ![Contacts Page](<LOCAL_SCREENSHOT_PATH>/08_contacts_after_contact_submit.png)
*   **Campaigns Interface**:
    ![Campaigns Send](<LOCAL_SCREENSHOT_PATH>/11_campaigns_details_mapped.png)
*   **Chatbot Management**:
    ![Chatbots](<LOCAL_SCREENSHOT_PATH>/14_chatbot.png)
*   **Chat Widget Setup**:
    ![Chat Widget](<LOCAL_SCREENSHOT_PATH>/15_chat_widget.png)
