...
| :--- | :---: | :--- | :--- |
| **WhatsApp/Inbox Sidebar Entry** | ✅ **Visible** | [client/src/shared/Layout.jsx](client/src/shared/Layout.jsx) | Located under "Inbox" on the user portal sidebar menu. |
| **Conversation Workspace** | ✅ **Active** | [client/src/pages/user/Inbox.jsx](client/src/pages/user/Inbox.jsx#L372) | Loads container `.inbox-console` and initiates Socket.IO connection loop. |
| **Customer Chat Thread Panel** | ✅ **Active** | [client/src/pages/user/Inbox.jsx](client/src/pages/user/Inbox.jsx#L428) | Loads the central panel `.wa-conversation-panel` displaying dynamic bubbles. |
| **Send Message Input Form** | ✅ **Active** | [client/src/pages/user/Inbox.jsx](client/src/pages/user/Inbox.jsx#L517) | Renders input field `.wa-composer` and submit buttons mapping to `sendMessage()`. |
| **Customer Context Panel** | ✅ **Active** | [client/src/pages/user/Inbox.jsx](client/src/pages/user/Inbox.jsx#L575) | Right-hand sidebar displaying contact info, agent assignment controls, and note saving. |
| **Media Attachments UI** | ✅ **Active** | [client/src/pages/user/Inbox.jsx](client/src/pages/user/Inbox.jsx#L528) | Form dropdown mapping to Image, Video, Document, and Audio file inputs. |
...
The backend Socket handler in [helper/socket/index.js](helper/socket/index.js#L445-L516) catches the payload:
