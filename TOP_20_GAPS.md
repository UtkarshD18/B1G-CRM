...
- **Required Files:** [helper/addon/qr/index.js](helper/addon/qr/index.js), [routes/qr.js](routes/qr.js), [client/src/pages/user/Integrations.jsx](client/src/pages/user/Integrations.jsx)
...
- **Required Files:** [routes/user.js](routes/user.js), [functions/function.js](functions/function.js)
...
- **Required Files:** [routes/webhooks.js](routes/webhooks.js), [helper/inbox/inbox.js](helper/inbox/inbox.js)
...
- **Required Files:** [routes/user.js](routes/user.js), [routes/admin.js](routes/admin.js), [routes/agent.js](routes/agent.js), [middlewares/user.js](middlewares/user.js)
...
- **Required Files:** [routes/web.js](routes/web.js)
...
- **Required Files:** [routes/inbox.js](routes/inbox.js), [socket.js](socket.js)
...
- **Required Files:** [middlewares/plan.js](middlewares/plan.js), [routes/phonebook.js](routes/phonebook.js)
...
- **Required Files:** [client/src/pages/user/DeveloperApi.jsx](client/src/pages/user/DeveloperApi.jsx), new routes
...
- **Required Files:** [routes/admin.js](routes/admin.js), [client/src/pages/admin/Settings.jsx](client/src/pages/admin/Settings.jsx)
...
- **Required Files:** New migration file, [database/schema.sql](database/schema.sql)
...
- **Required Files:** [routes/inbox.js](routes/inbox.js), [helper/inbox/inbox.js](helper/inbox/inbox.js)
...
- **Required Files:** Telegram helper modules, [routes/user.js](routes/user.js)
...
- **Required Files:** [routes/phonebook.js](routes/phonebook.js), [client/src/pages/user/Contacts.jsx](client/src/pages/user/Contacts.jsx)
...
- **Required Files:** [routes/inbox.js](routes/inbox.js), [client/src/pages/user/Inbox.jsx](client/src/pages/user/Inbox.jsx)
...
- **Required Files:** [routes/admin.js](routes/admin.js), encryption helper
...
- **Required Files:** [socket.js](socket.js)
